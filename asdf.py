...
GAMMA                       =      0.5              #   gamma = discount factor. High gamma value means focus on future rewards "
STARTING_EPSILON            =      0.5 # exploit or explore, 0 = exploit fully, 1 = explore fully
 
#These are the reward parameters. You need to change this. Refer to the guide to know what each means in detail
DESTROY_SOFTBLOCK           =      150   
DO_DAMAGE                   =      50
TAKE_DAMAGE                 =      -40  
EARN_AMMO                   =      20
...
BOMB_IN_RANGE               =      -20
PLACING_BOMB_ON_TOP_OF_BOMB =      -10
EXIST_PENALTY               =      -5
...
GUIDANCE                    =       0                       # 1 means the agent copies exactly as the coach. 0 means that the agent makes random moves Should be between 1 and 0
